defmodule HelloElixirWeb.ProductLive.FormComponent do
  ...
  def update(%{product: product} = assigns, socket) do
    {:ok,
     ...
     |> assign(assigns)
     |> assign_new(:form, fn ->
       to_form(Market.change_product(product))
     end)}
  end

  @impl true
  def handle_event("validate", %{"product" => product_params}, socket) do
    changeset = Market.change_product(socket.assigns.product, product_params)
